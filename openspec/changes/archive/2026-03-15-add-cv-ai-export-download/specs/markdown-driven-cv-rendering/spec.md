...
The rendering pipeline MUST map markdown files to stable section IDs, preserve the required section order for both locales, maintain parser-friendly list structures for skills and technology keywords, and keep exported JSON section ordering aligned with rendered section ordering.
...
- **AND** JSON export for each locale preserves the same section ID order as the rendered page
