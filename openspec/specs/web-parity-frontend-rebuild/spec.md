# Web Parity Frontend Rebuild Specification

## Purpose
Define requirements for rebuilding the `/frontend` application from canonical `/web` artifacts while preserving the approved visual contract.
