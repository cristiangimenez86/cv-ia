# CV Content Quality Optimization Specification

## Purpose
Define content-quality constraints for locale markdown sources so CV text remains single-language per locale, ATS-readable, and factually accurate during rewrites.
