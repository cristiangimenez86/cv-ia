# Developer Verification Workflow Specification

## Purpose
Define the canonical local and CI verification workflow so contributors can run consistent checks for linting, build, tests, and integration readiness before merging changes.
